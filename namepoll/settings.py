# Django settings for namepoll project.
...
DATABASES = {
    'default': {
        ...
        'NAME': join(expanduser('~'), 'noname/noname.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&ynj6ik)#g*@%=7=3tauf4oc%i$gdk8%ejc_wc+8u0+a%1ycg='
